...
local const_custom = const or {'ANN', 'TKO', 'LUZCID', 'Macntaj', 'HAILO', 'RJD2', 'M1A1', 'LP4', 'MGMT', 'REVOFEV', 'UK', 'NYC', 'MSK', 'AVIA', 'VIP', 'SBTRKT', 'GMO', 'ATL', 'PBS', 'TRON', 'TN', 'CPU', 'OnFlow', 'JME', 'IPlayYouListen', 'PDA', 'SUN_MONX', 'SUN:MONX', 'JP', 'SpVce', 'saQi', 'VLA', 'MB', 'BT', 'DFRNT', 'SubDivision', 'OST', 'DYL', 'HLZ', 'JS16', 'y', 'MF', 'DOOM', 'ARF', 'GUNSHIP', 'PDX' }
