...
let
  mkDeckyPlugin = pkgs.callPackage ./packages/mk-plugin.nix { };
  ...
  brightnessBar = pkgs.callPackage ./packages/brightness-bar.nix {
    inherit mkDeckyPlugin;
  };
  catalog = import ./packages/catalog.nix { inherit pkgs; };
  patched = {
    "SDH-AnimationChanger" = pkgs.callPackage ./packages/animation-changer-enhanced.nix {
      inherit mkDeckyPlugin animationConfig;
    };
    "decky-autosuspend" = pkgs.callPackage ./packages/autosuspend.nix {
      inherit mkDeckyPlugin;
    };
    "SDH-CssLoader" = pkgs.callPackage ./packages/css-loader.nix {
      inherit mkDeckyPlugin;
    ...
    "decky-XRGaming" = pkgs.callPackage ./packages/xrgaming.nix {
      inherit mkDeckyPlugin;
    };
  };
in
