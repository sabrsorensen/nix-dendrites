{ inputs }:
{
  # This is deliberately a normal broadcast module.  The GUI fact gates both
  # the NUR overlay and the Home Manager profile on hosts that actually use it.
  flake.modules.nixos.firefox =
    ...
    let
      ...
      customAddons = pkgs.callPackage ./_firefox-addons.nix { inherit buildMozillaXpiAddon; };
    ...
    lib.mkIf enabled {
      ...
      home-manager.users.${username} = {
        home.persistence = lib.mkIf host.features.impermanence {
